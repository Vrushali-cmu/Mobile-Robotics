classdef cubicSpiral < handle
    ...
    methods(Static = true)
        ...
        function makeLookupTable(scale)
            ...
            plotSamples = 10000;
            plotArrayX = zeros(plotSamples,1);
            plotArrayY = zeros(plotSamples,1);
    ...
    methods(Access = public)
       ...
       function planVelocities(obj,Vmax)
        ...
        function world = getWorldAtTime(obj,t)
            x = interp1(obj.timeArray,obj.worldArray(1,:),t,'pchip','extrap');
            y = interp1(obj.timeArray,obj.worldArray(2,:),t,'pchip','extrap');
            world = [x;y];
        end
